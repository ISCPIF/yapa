...
object YapaBuild extends Build {
 ...
 lazy val gui = Project(id = "gui", base = file("gui")) settings (libraryDependencies ++= Seq("org.scala-lang" % "scala-swing" % "2.10.1", "net.schmizz" % "sshj" % "0.1.1")) dependsOn(yapa, uri("git://github.com/roguePanda/java-terminal.git#88eb0e64670adcb112af14832cdc57721b94af14"))
